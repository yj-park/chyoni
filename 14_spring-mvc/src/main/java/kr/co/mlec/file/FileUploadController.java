...
public class FileUploadController {
	...
	// 파일에 대한 정보를 가지고 있는 MultipartHttpServletRequest
	public ModelAndView fileUpload(MultipartHttpServletRequest mRequest) throws Exception {
		...
		// 사용자가 선택한 이름을 먼저 얻어올게! 여러개일 수 있으니까 순환자를 사용해서 처음부터 끝까지 반복할게
		Iterator<String> iter = mRequest.getFileNames();
		// 데이터가 있으면 (attachFile1, attachFile2)
		while(iter.hasNext()) {
			...
			if(oriFileName != null && !oriFileName.equals("")) {
				...
				// mFile에 있는 내용은 메모리에만 있는 내용 (file rename이랑 비슷)
